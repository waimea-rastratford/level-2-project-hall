...
The inefficiency of recording dates and bookings for spring grove hall
...
A system that displays all concurrent, future and past bookings with a name.
...
Privacy, ensuring the user's details are kept safe
